...
public class EvidenceUploaderStage extends Stage {
    public EvidenceUploaderStage() throws IOException {
        Parent root = FXMLLoader.load(COILVICApplication.class.getResource("fxml/EvidenceUploaderFXML.fxml"));
